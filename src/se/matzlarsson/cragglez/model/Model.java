...
public class Model {
    ...
    private Model(){
        ...
        layers.add(new Layer("Music", 0, 0, -100, -100, 10, 10, false));
        layers.add(new Layer("Main video", 1, 5, 25, 25, 50, 50, true));
    }
    ...
    public void createLayer(String name, int screen, int level, int x, int y, int width, int height, boolean usePercentage){
        layers.add(new Layer(name, screen, level, x, y, width, height, usePercentage));
    }
